...
public class Teacher extends User{
	...
	public Teacher(String name, String userName, String password, UserType userType, List<Subject> subjects) {
		super(name, userName, password, userType);
		this.subjects = subjects;
	}

	public Teacher(String name, String userName, String password, UserType userType) {
		super(name, userName, password, userType);
		// TODO Auto-generated constructor stub
	}
